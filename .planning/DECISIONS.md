...
- SUPERSEDED BY v2.0, DO NOT PROMPT FROM THIS: Board traits locked in studio.visual_characters: age 45 to 52, 5'10", athletic solid build, short tapered waves, well groomed salt and pepper beard, gold or bronze frames, palette #641E2C #351018 #F7F3EB #161616 #9A633B #B39562.
- SUPERSEDED BY v2.0, DO NOT PROMPT FROM THIS: Wardrobe is an asset, not a prompt: UC_WARDROBE_001 cream knit quarter zip polo, UC_PANTS_001 dark tailored trousers, UC_SHOES_001 brown leather loafers, UC_GLASSES_001 gold frames, UC_WATCH_001 gold watch. Office is LOCATION UC_OFFICE_001, built as a virtual set with approved plates per camera direction.
...
- Prompt law (Boss, 2026-09-03): Uncle Cred wears no eyewear, ever. Renders kept adding glasses because prompts were hand written from the identity v1.0 board above instead of read from studio.visual_characters, where physical_traits.eyewear already said "never" and metadata.negative_prompt already banned glasses and the polo. Character prompts are now assembled from the canon row by packages/generation-router buildCharacterPrompt, and the row's negative_prompt is always applied. No caller writes a character prompt by hand.
