...
4. THE LOOK. Per character, a grid of generated candidates (FLUX.2 via the router). Tap the one that is him. That image becomes the canonical front reference, the turnaround and expression sheets generate from it, LoRA v1 trains in the background. Outcome: a locked face per character.
